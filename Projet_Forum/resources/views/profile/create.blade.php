<x-master_admin>
        ...
        <div class="container w-75 mx-auto mt-2" style="color: #891659" >
          <form class="w-75 p-4 mx-auto" action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
            @csrf   
                ...
                <div class=" w-25 mx-auto mt-2 mb-5 ">
                  ...
                  <div class="row g-2">
                    ...
                    <div class="d grid mx-auto w-25">
                      <button type="submit" class="btn" style="background-color:#891659;color:white;">Add user</button>
                    </div>
                  </div>
        </form>  
        </div>
